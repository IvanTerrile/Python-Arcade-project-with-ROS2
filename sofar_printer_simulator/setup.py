...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'shape_service = sofar_printer_simulator.shape_service:main',
            'robot_logic = sofar_printer_simulator.robot_logic:main',
            'motor_x = sofar_printer_simulator.motor_x:main',
            'motor_y = sofar_printer_simulator.motor_y:main',
        ],
    },
)
